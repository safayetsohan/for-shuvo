...
train_data_dir = 'C:/resnet50dense/training'
validation_data_dir = 'C:/resnet50dense/validation'
...
filepath = 'C:/resnet50dense/vlva/model-densenet201-retrain-{epoch:02d}-{val_loss:.2f}-{val_acc:.4f}.hdf5'
...
model.save('C:/resnet50dense/ms/rakuten_densenet201_retrain_model.h5')					  
